...
```
\begin{warningBox}
The current forecast models face limitations due to the unavailability of project data beyond the current and past CDM. This resulted in forecasts exhibiting high uncertainty, characterized by large residuals and broad prediction intervals.
