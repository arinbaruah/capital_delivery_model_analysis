...
p_value_framework <- mean(abs(perm_diff) >= abs(obs_diff)) # 2-sided permutation test
...
pl10 <- model_fc |> autoplot() +
  ...
  labs(
    ...
    title = "Forecasted number of projects in CDM-26 using ETS (ANA) model",
    subtitle = "Projects worth 5 mil $ or lower"
  ) + theme_minimal()
