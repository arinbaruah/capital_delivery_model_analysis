...
#t.test(framework_cdm21,framework_cdm16)$p.value 
...
# Permutation test for framework
...
# %>% mutate(delivery_program_dummy = case_when(delivery_program == "Major Works - Small Scale" ~ "Small scale projects",
