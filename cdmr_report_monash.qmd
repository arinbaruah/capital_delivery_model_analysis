...
medduration <- project_data %>% filter(status == "Completed") %>% 
  ...
  geom_label(aes(label = round(Median_completion,0),fontsize = 5,hjust = 1)) +  theme_minimal() + theme(legend.position = "none",
                                                                        plot.title = element_text(size = 10),
                                                                        plot.subtitle = element_text(size = 8),
                                                                        axis.text = element_text(size = 7)) + 
...
(delduration + medduration) +
  ...
  plot_annotation(
    theme = theme(plot.background = element_rect(color = "white", size = 2, fill = "white"),
